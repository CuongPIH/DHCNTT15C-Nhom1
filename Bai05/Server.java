...
public class Server {
    public static void main(String[] args) {
        try{
            ...
            System.out.println("UDP server đã được tạo");
            ...
            do{
                ...
                Thread.sleep(500);
                DatagramPacket gui = new DatagramPacket(str1.getBytes(),str.length(),nhan.getAddress(),nhan.getPort());
                s.send(gui);
